...
export default class LoginPageComponent extends BaseComponent {
  ...
  private areFieldsValid(): boolean {
    ...
    const nameFieldErrors = LoginPageComponent.getFieldValidationErrors('Login', nameFieldValue, FieldMinLength.NAME);
  ...
  private onSubmitButtonClick = (evt?: Event | undefined): void => {
    ...
    if (this.areFieldsValid()) {
      this.storage.setAuthData({
        login: this.nameField.getInputValue(),
        password: this.surnameField.getInputValue(),
      });
